...
import { NewBookFormStateType, BookType } from "../../types";
import {
...
const useEditBookForm = (nObjBook: BookType | null, onSubmit?: () => void) => {
  ...
  useEffect(() => {
    ...
    const { strBase64ImageFile, description, ...objMandatoryFields } =
      objNewBook;
